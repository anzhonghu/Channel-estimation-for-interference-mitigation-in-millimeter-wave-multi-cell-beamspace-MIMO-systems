...
el_in = zeros(Mb, 1);
az_in = zeros(Mb, 1);
capacity = zeros(length(Tc_store),  12);
nmse = zeros(length(Tc_store),  12);
esti_err = zeros(length(Tc_store),  3);
angle = zeros(1, 2);
flagforesprit = 0;
...
for signalpo_n = 1 : length(Tc_store)
    Tc = Tc_store(signalpo_n, 1);
    N = Tc-K;
    N_1 = Tc - 1;
    for ii = 1 : Nite
        pos = zeros(K, 3);
...
subplot(1,2,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(Tc_store, capacity(1:length(Tc_store), 3), 'k--d','LineWidth',2,'MarkerSize',14)
hold on
plot(Tc_store, capacity(1:length(Tc_store), 1), 'k--^','LineWidth',2,'MarkerSize',14)
plot(Tc_store, capacity(1:length(Tc_store), 6), 'k--x','LineWidth',2,'MarkerSize',10)
plot(Tc_store, capacity(1:length(Tc_store), 4), 'k--v','LineWidth',2,'MarkerSize',10)
plot(Tc_store, capacity(1:length(Tc_store), 12), 'k-o','LineWidth',2,'MarkerSize',10)
plot(Tc_store, capacity(1:length(Tc_store), 9), 'k-s','LineWidth',2,'MarkerSize',10)
...
xlabel('Channel coherence interval','Fontsize',20,'Fontname','Times')
ylabel('Spectral efficiency (bps/Hz)','Fontsize',20,'Fontname','Times')
grid on

subplot(1,2,2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(Tc_store, nmse(1:length(Tc_store), 3), 'k--d','LineWidth',2,'MarkerSize',14)
hold on
plot(Tc_store, nmse(1:length(Tc_store), 6), 'k--x','LineWidth',2,'MarkerSize',10)
plot(Tc_store, nmse(1:length(Tc_store), 12), 'k-o','LineWidth',2,'MarkerSize',10)
xlim([min(Tc_store), max(Tc_store)])
ylim([0,200])
