...
nmse = zeros(length(K_store),  12);
esti_err = zeros(length(K_store),  3);
angle = zeros(1, 2);
flagforesprit = 0;
...
subplot(1,2,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(K_store, capacity(1:length(K_store), 3), 'k--d','LineWidth',2,'MarkerSize',14)
hold on
plot(K_store, capacity(1:length(K_store), 1), 'k--^','LineWidth',2,'MarkerSize',14)
plot(K_store, capacity(1:length(K_store), 6), 'k--x','LineWidth',2,'MarkerSize',10)
plot(K_store, capacity(1:length(K_store), 4), 'k--v','LineWidth',2,'MarkerSize',10)
plot(K_store, capacity(1:length(K_store), 12), 'k-o','LineWidth',2,'MarkerSize',10)
plot(K_store, capacity(1:length(K_store), 9), 'k-s','LineWidth',2,'MarkerSize',10)
...
xlabel('Number of MSs in each cell K','Fontsize',20,'Fontname','Times')
ylabel('Spectral efficiency (bps/Hz)','Fontsize',20,'Fontname','Times')
grid on

subplot(1,2,2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(K_store, nmse(1:length(K_store), 3), 'k--d','LineWidth',2,'MarkerSize',14)
hold on
plot(K_store, nmse(1:length(K_store), 6), 'k--x','LineWidth',2,'MarkerSize',10)
plot(K_store, nmse(1:length(K_store), 12), 'k-o','LineWidth',2,'MarkerSize',10)
xlim([min(K_store), max(K_store)])
% ylim([0,500])
